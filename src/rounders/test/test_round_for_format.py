...
from rounders.format import round_to_format
...
class TestRoundForFormat(unittest.TestCase):
    ...
    def test_maximum_figures(self) -> None:
        ...
        test_values = [
            ...
            # Check that exponent gets bumped where necessary
